      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-brand">
            <a href="#home" className="footer-logo gradient-text">
              {initials}
            </a>
          ...
          <div className="footer-made-with">
            <span>Made with</span>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="var(--color-primary)" className="footer-heart">
              <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
            </svg>
            <span>by {profileSettings?.footer_copyright || name}</span>
          </div>
          ...
          <div className="footer-right">
            ...
            <button
              onClick={scrollToTop}
              className="scroll-top-btn glass hover-glow"
